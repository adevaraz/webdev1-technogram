<template>
  <v-container pt-2 :loading="isLoading" height="100%">
    <template slot="progress">
      <v-progress-linear color="#E52B38" height="10" indeterminate />
    </template>
    ...
    <v-col>
      ...
      <v-row align="center" justify="center">
        <img
          id="vector"
          src="../../../assets/verification/email-amico.svg"
          alt="verification email sent illustration"
        />
      </v-row>
      <v-row align="center" justify="center">
        <a href="https://storyset.com/marketing"
          >Ilustrasi oleh Freepik Storyset</a
        >
      </v-row>
